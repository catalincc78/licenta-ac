            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Admin Dashboardaaaa</h1>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <th> {{ $player->age }} </th>
                                            <th> {{ $player->market_value }} <span style="color:red">$</span></th>
                                            <th> {{ $player->post}} </th>
                                            <th> <div class="d-flex align-items-center d-flex align-items-center justify-content-between">
                                                    <button class="card bg-success text-white mb-2">
                                                        <div class="card-body">Edit</div>
                                                    </button>
                                                    <button class="card bg-danger text-white mb-2">
