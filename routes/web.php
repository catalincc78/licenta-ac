...
Route::prefix('user')->name('user.')->group(function() {
    ...
    Route::middleware(['auth:web','PreventBackHistory'])->group(function(){
        ...
        Route::post('/stergere-produs/{id}', [ProdusController::class, 'stergereProdus'])->name('produse.stergere-produs');
        Route::post('/submit-adaugare',[ProdusController::class, 'adaugareProdus'])->name('produse.adaugare');
        Route::get('/lista-produse',[ProdusController::class, 'listaProduse'])->name('produse.lista');
...
Route::prefix('admin')->name('admin.')->group(function() {
    ...
    Route::middleware(['guest:admin','PreventBackHistory'])->group(function(){
        ...
        Route::post('/check-admin',[AdminController::class,'check'])->name('check-admin');
